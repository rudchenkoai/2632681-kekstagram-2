...
const createPost = (_,index) => ({
  ...
  likes: getRandomPositiveInteger(LikesQuantity.MIN,LikesQuantity.MAX),
  comments: Array.from({length: getRandomPositiveInteger(CommentsQuantiyty.MIN,CommentsQuantiyty.MAX)}, createComment),
});
